...
- **Twenty-fifth post-launch live-tweak round (2026-08-25, same session):** new mobile-only rule `.llv-process { margin-top: 25px; }` (no prior mobile override existed for this selector beyond the shared `padding: 50px 0`).
