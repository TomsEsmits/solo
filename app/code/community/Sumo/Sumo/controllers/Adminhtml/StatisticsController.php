...
class Sumo_Sumo_Adminhtml_StatisticsController extends Mage_Adminhtml_Controller_Action {
  ...
  */
   ...
   protected function _initAction() {
        $this->loadLayout()
            ->_setActiveMenu('sumo_admin/adminhtml_statistics')
            ->_title('Sumo');
  ...
  public function indexAction() {
      ...
      $this->getRequest()->setParam('page','statistics');
